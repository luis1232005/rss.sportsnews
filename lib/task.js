    ...
    },
    {
        ...
        success : function(html,opts){
            ...
            _.each(items,function(item,index){
                ...
                item.author = '网易网';
                item.pubDate = new Date(temp[3] + '-' + (now.getMonth()+1) + '-' + temp[1] + ' ' + temp[4]).getTime();
                item.img = '';
    ...
    },
    {
        ...
        success : function(html,opts){
            ...
            $('.wdls').each(function(){
                ...
                item.author = '华体网';
                item.pubDate = new Date(new Date().getFullYear() + '-' + $("ul ol",this).text().split('  ')[1]).getTime();
    ...
    },
    {
        ...
        success : function(html,opts){
            ...
            $('.ulline li').each(function(){
                ...
                item.description = '';
                item.author = '体坛网';
                item.pubDate = new Date(new Date().getFullYear() + '-' + $(".date",this).text()).getTime();
                item.img = '';
