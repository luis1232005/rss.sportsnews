...
var rssMap = [
    {
        ...
        success : function(html,opts){
            ...
            console.log(items[0].link,cUtil.dateFormat(new Date(items[0].pubDate),'yyyy-MM-dd hh:mm:ss'));
            _.each(items,function(item,index){


                item.author = '新浪网';
                item.pubDate = new Date(cUtil.dateFormat(new Date(item.pubDate),'yyyy-MM-dd hh:mm:ss'));
                item.img = '';
    ...
    //            item.author = '网易网';
    //            item.pubDate = new Date(temp[3] + '-' + (now.getMonth()+1) + '-' + temp[1] + ' ' + temp[4]);
    //            item.img = '';
    ...
    //            item.author = '华体网';
    //            item.pubDate = new Date(new Date().getFullYear() + '-' + $("ul ol",this).text().split('  ')[1]);
    ...
    //            item.description = '';
    //            item.author = '体坛网';
    //            item.pubDate = new Date(new Date().getFullYear() + '-' + $(".date",this).text());
    //            item.img = '';
